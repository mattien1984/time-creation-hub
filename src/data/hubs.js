...
// Sep 2026): the TCP foundation + daylight pages, robdyrdek.com / Studio
// Dyrdek gateway, Existence HIW (index-v3) and the Founding Member page.
// Rob Dyrdek's sacred copy (TCP story paragraphs, closer lines) is verbatim —
// never paraphrase it. Open questions live in BRAND-QUESTIONS.md.
  ...
  'time-creationism': {
    ...
    story: {
      ...
      paragraphs: [
        ...
        'It is the organizing belief of the whole universe. Where the foundation is raw potential, Time Creationism gives it form — the conviction that time is not spent or found but authored, the grid of agency along which moments can be arranged, measured, and made.',
        ...
        'The belief does not stand alone. Existence is the instrument that puts it into practice, and the Time Creation Project is the foundation that carries it to the world. In Rob Dyrdek’s words: "Every person creates their life through the way they create their time."',
      ],
    },
    universeRole:
    ...
    persona: {
      body: 'The self-authorship seeker: someone who feels trapped by scarcity-framed "time management" and wants agency over their life, not efficiency in their schedule. A reflective, growth-oriented person drawn to intention, energy, and meaning rather than productivity hacks; the villain in their story is the unchanged calendar, never another person or brand. As the parent philosophy, it also speaks to the widest ring of the ecosystem: people who may never open the app but can adopt the belief — including the audience that follows Rob Dyrdek personally and meets the philosophy through him.',
    },
    voice: {
      principles: [
